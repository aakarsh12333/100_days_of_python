...
# ===================================================================================
# * Step 1 :- Importing all necessary libraries used to make make alarm clock app   *
# ===================================================================================

from tkinter import *  # * Belongs to a standard library of GUI in Python.It helps us to to create a dialog box with any information that we want to provide or get from the users.
import datetime  # ! Datetime and time modules in python help us to work with the dates and time of the current day when the users is operating python and to manipulate it too.
import time 
import winsound # * module provides access to the basic sound playing machinery provided by Windows platforms. This is useful to generate the sound immediately when a function is called

# ========================================
# ? Step 2 :- Creating a while loop :-   
# ========================================
...
'''
⌈                                                                                                                                                                                                                              ⌉
  ⇝ Explanation of the code in detailed :-
